...
# Use MODEL_DIR env var (works for both Railway and Render)
MODEL_DIR = os.getenv("MODEL_DIR", "/app/models")
HF_REPO_ID = "intxnk01/tourgether-models"
HF_TOKEN = os.getenv("HF_TOKEN")

def download_all_models():
    """Main entry point for model downloading on startup"""
    ...
    if not os.path.exists(faiss_dest):
        ...
        logger.info("✅ FAISS embeddings downloaded successfully.")
    else:
